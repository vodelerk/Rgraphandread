...
###########################################################
#                   Diplomado
#     Anal韙ica y Grandes Vol鷐enes de Datos
#               Universidad Icesi
###########################################################
#          Estad韘tica para la anal韙ica                 
###########################################################
#           Julio C閟ar Alonso
#           Profesor Titular
...
# pareciera mejor 2 clusters (y el m撮todo average)
...
# De tres a cuatro y de ahi en adelante no existe un aumento grande. As错 que todo parede que 2 0 3 clusters es lo ideal.
...
#Seguiremos usando dos clusters y el m撮todo de average
...
# 縠xiste direfencia entre los grupos?
...
# Dado que el promedio para UrbanPop no es estad错sticamente diferenite para los grupos (clusters),
#       se puede afirmar que esa variable no aporta para caracterisar el cluster. 
###############################################################
###############################################################
# Ahora realizemos el mismo an瘁lisis pero sin la vaible UrbanPop 
# 
      ...
      #Podemos emplear esta agrupaci大n para trabjar.    
...
# 緾大mo interpretar estos dos grupos?
# 
