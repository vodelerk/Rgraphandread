...
###########################################################
#                Teorema del L???mite Central  (TLC)       #
###########################################################

# 1. Generar una muestra de tama???o n desde una distribuci???n
#  uniforme
#  
...
TLC <-function(n, m){
  ...
  # m= n???mero de repeticioines (veces que se calcula la media)
  # 
